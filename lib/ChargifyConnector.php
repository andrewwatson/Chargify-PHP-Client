...
{
	private $api_key = '5iaFe8FWHSL2BN8ZCuyF';
	private $test_api_key = '5iaFe8FWHSL2BN8ZCuyF';
	private $domain = 'voicecloud'; //your chargify domain, e.g. if you have [your-domain].chargify.com, then enter "your-domain" only.
	private $test_domain = 'voicecloud';
